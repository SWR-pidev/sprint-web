...
class Event
{
    ...
    public function getProfilePictureAbsolutePath() {
        return null === $this->urlEvt
            ? null
            : $this->getUploadRootDir().'/'.$this->urlEvt;
    }
    /**
    ...
    public function getWebProfilePicturePath() {
        ...
        return '/'.$this->getUploadDir().'/'.$this->getUrlEvt();
    }
    ...
    public function uploadProfilePicture() {
        ...
        $filesystem = new Filesystem();
            $this->setUrlEvt(uniqid('f_').'.'.'png');
        $filesystem->copy($this->getFile(),$this->getUploadRootDir()."/".$this->getUrlEvt());
